...
-- HNSW gives high recall by default (no probe tuning) and scales well. At small
-- row counts this matters: an ivfflat index with many lists under the default
-- probes=1 would return too few rows for a top-k query.
-- ----------------------------------------------------------------------------
